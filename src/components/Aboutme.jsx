...
const Aboutme = () => {
  ...
  return (
    <>
      <div
        id="aboutme"
        className="relative bg-gradient-to-b from-blue-900 via-cyan-500 to-[#060648] max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12 
        px-6 "
      >
        {/* Background Image for Mobile & Tablet */}
        <div className="absolute inset-0 bg-cover bg-center opacity-20 md:hidden" style={{ backgroundImage: `url(${image})` }}></div>
